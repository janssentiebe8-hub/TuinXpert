...
const projects: Project[] = [
  {
    id: 1,
    title: 'Oprit met gazon',
    category: 'Bestrating',
    location: 'Mol',
    year: 2024,
    image: '/images/realisaties/foto-1.jpeg',
    alt: 'Aangelegde oprit met betonnen tegels en gazon door TuinXpert in Mol',
    description: 'Volledige aanleg van een betonnen oprit gecombineerd met een strak gazon langs een nieuwbouwwoning.',
    size: 'tall',
  },
  {
    id: 2,
    title: 'Kasseien terras & oprit',
    category: 'Bestrating',
    location: 'Mol',
    year: 2024,
    image: '/images/realisaties/foto-7.jpeg',
    alt: 'Kasseien terras en oprit aangelegd door TuinXpert',
    description: 'Aanleg van een ruim terras en oprit in kasseien, inclusief drainage en zandbed.',
    size: 'tall',
  },
  {
    id: 3,
    title: 'Betonnen oprit nieuwbouw',
    category: 'Bestrating',
    location: 'Mol',
    year: 2024,
    image: '/images/realisaties/foto-2.jpeg',
    alt: 'Betonnen oprit aangelegd bij nieuwbouwwoning door TuinXpert',
    description: 'Aanleg van een betonnen oprit bij een nieuwbouwwoning, met nette afwerking en boordstenen.',
    size: 'normal',
  },
  {
    id: 4,
    title: 'Oprit met kiezelstroken',
    category: 'Bestrating',
    location: 'Mol',
    year: 2024,
    image: '/images/realisaties/foto-6.jpeg',
    alt: 'Oprit met betonnen tegels en decoratieve kiezelstroken door TuinXpert',
    description: 'Oprit aangelegd met afwisseling van betonnen tegels en decoratieve kiezelstroken voor een moderne look.',
    size: 'normal',
  },
  {
    id: 5,
