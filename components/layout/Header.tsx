            ...
            >
              ...
              <div className="p-6 border-t border-groen border-opacity-10">
                <Link
                  href="/contact"
                  onClick={() => setMobileOpen(false)}
                  className="block w-full text-center font-body font-semibold text-sm bg-groen-neon text-white px-5 py-3 rounded-md hover:bg-groen-helder hover:text-white transition-all duration-300 hover:shadow-groen-glow"
                >
                  Offerte aanvragen
                </Link>
                <a
