...
const faqs = [
  ...
  },
  {
    ...
    antwoord:
      'Wij zijn voornamelijk actief in de Kempen, met Geel als thuisbasis. Wij werken in de ruime omgeving van Geel, Mol, Balen, Herentals, Westerlo, Laakdal en andere gemeenten in de Antwerpse Kempen. Twijfelt u of uw gemeente in ons werkgebied valt? Neem gerust contact op — wij bekijken het graag voor u.',
