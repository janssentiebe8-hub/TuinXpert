    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          <tr>
            <td style="background-color:#ffffff;border-radius:12px 12px 0 0;padding:48px 48px 36px;text-align:center;border-top:5px solid #2C632F;">
              <div style="display:inline-block;margin-bottom:24px;">
                <img src="https://tuinxpert.be/logo/TuinXpert-Logo_Full.png" alt="TuinXpert" height="75" style="display:block;" />
              </div>
              <div style="width:48px;height:2px;background-color:#2C632F;margin:0 auto 24px;border-radius:2px;"></div>
              <h1 style="margin:0;font-family:Georgia,serif;font-size:26px;color:#2C632F;font-weight:normal;line-height:1.4;">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:48px;">
              ...
              <p style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:15px;color:#555555;line-height:1.8;">
                We hebben uw offerte aanvraag goed ontvangen en gaan er mee aan de slag. Binnen <strong>2 werkdagen</strong> nemen we contact met u op om uw wensen te bespreken.
              </p>
              <div style="border-top:1px solid #e8efe8;margin:32px 0;"></div>
              <h2 style="margin:0 0 20px;font-family:Georgia,serif;font-size:18px;color:#2C632F;font-weight:normal;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:14px 16px;background-color:#f4faf7;border-left:3px solid #2C632F;border-radius:0 6px 6px 0;">
              ...
              <p style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:15px;color:#555555;line-height:1.8;">
                Heeft u nog vragen? Aarzel dan niet om ons te contacteren via <a href="mailto:info@tuinxpert.be" style="color:#2C632F;text-decoration:none;font-weight:bold;">info@tuinxpert.be</a> of bezoek onze website.
              </p>
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="border-radius:6px;background-color:#2C632F;">
              ...
              <p style="margin:36px 0 0;font-family:Arial,sans-serif;font-size:15px;color:#555555;line-height:1.8;">
                ...
                <strong style="color:#2C632F;">Het TuinXpert team</strong>
              </p>
            </td>
          </tr>
          <tr>
            <td style="background-color:#2C632F;border-radius:0 0 12px 12px;padding:28px 48px;text-align:center;">
